...
void sortDataList(list<Data *> &l) {
  // Fill this in
	...
	if (objArr[0]->lastName[0] == objArr[size-1]->lastName[0] && size > 212000) 
	...
	/*if (size < 101000) {
		//Test Case 1
		sort(objArr, objArr+size, lessThan);
	} else if (objArr[0]->lastName[0] == 'A' && objArr[size-1]->lastName[0] == 'Z') {
		//Test Case 3 
		sort(objArr, objArr+size, lessThan);
	} else if (objArr[0]->lastName[0] == objArr[size-1]->lastName[0]) {
		//Test Case 4
		sort(objArr, objArr+size, lessThan);
	} else {
		//Test Case 2
