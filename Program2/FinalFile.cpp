...
public:
	...
	Node* get_head() { return first_node; }
	Node* get_tail() { return last_node; }
	string get_name() { return name; }
	virtual void push(T i) = 0; //virtual functions so dervied classes call the right function
	virtual T pop() = 0;        //at run-time 
...
void pop(ofstream &outputFileObj, list<SimpleList<T> *> metaList, string name) {
	...
	if (pSL->get_head() == NULL && pSL->get_tail() == NULL) {
